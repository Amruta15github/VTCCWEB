                    ...
                    <div class="row">
                       ...
                       <%-- <div class="col-lg col-md-6 footer-contact">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>Quick Links</h4>
                            <ul>
                                <li><i class="fa fa-angle-right"></i>&nbsp;<a href="<%=rootPath +"#"%>">VTCC Learning Center</a></li>
                                <li><i class="fa fa-angle-right"></i>&nbsp;<a href="<%=rootPath +"Affiliation-centers"%>">Exam Centers</a></li>
