<%@ Page Title="Career Addphotos | VTCC" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="add-career-photo.aspx.cs" Inherits="adminpanel_add_career_photo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <h2 class="pgTitle">Add CareerActivity Photos </h2>
    <span class="titlecolor"><%= caracttitle %></span> 
        ...
        <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="form-group col-md-6">
                ...
                <label>CareerActivity Image:*</label>
                <asp:FileUpload ID="fuImg" runat="server" CssClass="form-control-file" />
                <span class="space10"></span>
                <%= caractPhoto %><span class="space5"></span>
