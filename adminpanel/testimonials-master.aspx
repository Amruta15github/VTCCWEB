<%@ Page Title="Testimonials | VTCC" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="testimonials-master.aspx.cs" Inherits="adminpanel_testimonials_master" %>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <asp:TextBox ID="txtTesDesc" runat="server" CssClass="form-control textarea" Height="200px" Width="100%" textmode="MultiLine"  MaxLength="300"></asp:TextBox>
                    </div>
