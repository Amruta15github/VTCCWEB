...
public partial class adminpanel_upload_certificate_list : System.Web.UI.Page
{
    iClass c = new iClass();
                            ...
                            if (arrCells.Length == 14 || arrCells.Length == 15)
                            {
                                if (arrCells[1].ToString() != "")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (c.IsRecordExist("Select CenterID From CentersData Where CenterRegNo='" + centerNo + "'"))
                                        {
                                            CenterNumber = Convert.ToInt32(c.GetReqData("CentersData", "CenterID", "CenterRegNo='" + centerNo + "'"));
                                        }
                                        else
                                        {
                                            CenterNumber = 0;
