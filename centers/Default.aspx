<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="centers_Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>VTCC Center Admin Login</title>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="login-box">
                    ...
                    <h3 class="titleTxt txtCenter">VTCC Center Login Panel<br/></h3>
                    <!-- /.login-logo -->
                    <div class="card">
