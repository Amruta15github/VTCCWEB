<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgetPwd.aspx.cs" Inherits="centers_forgetPwd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>VTCC Center Forgot Password</title>
        ...
        <div>
            <div class="login-box">
                <div class="login-logo">
                    <h3 class="titleTxt txtCenter">Forgot Password?<br /></h3>
                    </div>
                  <!-- /.login-logo -->
                <div class="card">
                    <div class="card-body login-card-body">
                        <p class="login-box-msg">Enter your registered Email.</p>
                          ...
                          <p class="mt-3 mb-1">
                            <a href="Default.aspx" class="fPass" title="Center Admin Login">Log In</a>
                        </p>
                    </div>
                    <!-- /.login-card-body -->
                    </div>
