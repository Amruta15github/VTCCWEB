...
public partial class centers_forgetPwd : System.Web.UI.Page
{
    iClass c = new iClass();
    ...
    protected void cmdRecover_Click(object sender, EventArgs e)
    {
        ...
        if (c.IsRecordExist("Select * From CentersData Where CenterEmailId='" + txtEmail.Text.Trim() + "'") == false)
        {
        ...
        string userPwd = c.GetReqData("CentersData", "CenterUserPwd", "CenterEmailId='" + userName + "'").ToString();
